...
contract FreePaymaster is BasePaymaster {
    ...
    event ValidateOp(address sender, uint256 nonce, uint48 validUntil, uint48 validAfter);
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        emit ValidateOp(userOp.getSender(), userOp.nonce, validUntil, validAfter);
